...
### Julian Plaisance
Minor documentation contribution to the SRS, SDD, STD, & PMD.  Helped Hanna design and document the UI, worked on several menus and other UI elements including most of the implementation of the UI implementation.  Designed several UI Black Box Test cases.  Talked with Kyle about Game Logic design.  I also synced the UI and Game Logic teams's code into a cohesive demo.
